Цей міні додаток є моєю імплементацією вступного тестового завдання на стажування в PortaOne в березні 2024. Сам додаток - https://portaonetesttask.azurewebsites.net/
